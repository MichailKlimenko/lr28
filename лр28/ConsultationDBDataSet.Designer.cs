...
namespace лр28.ConsultationDBDataSetTableAdapters {
...
SELECT Id, FullName, Subject, Date, TimeSlot, IsBooked FROM Consultations WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::лр28.Properties.Settings.Default.ConsultationDBConnectionString;
        }
